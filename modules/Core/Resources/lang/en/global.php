...
return [
    ...
    'swal' => [
        ...
        "swal-update-confirmed" => "You have updated all the selected items!",
        ...
        "swal-restore-confirmed" => "You have restored all the selected items!",
        ...
        "swal-restore-discarded-single" => "The selected item has not restored.",
    ],
    'toastr' => [
        'toastr-deleted-row' => 'deleted successfully',
        'toastr-hard-deleted-row' => 'permanently deleted successfully',
        'toastr-deleted-rows' => 'deleted successfully',
        'toastr-hard-deleted-rows' => 'permanently deleted successfully',
        'toastr-updated-row' => 'updated successfully',
        'toastr-updated-rows' => 'updated successfully',
        'toastr-added-row' => 'added successfully',
